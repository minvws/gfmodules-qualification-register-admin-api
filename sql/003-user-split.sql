...
GRANT SELECT,UPDATE,DELETE ON vendors TO qualification_admin;
GRANT SELECT,UPDATE,DELETE ON protocols TO qualification_admin;
GRANT SELECT,UPDATE,DELETE ON protocol_versions TO qualification_admin;
GRANT SELECT,UPDATE,DELETE ON roles TO qualification_admin;
GRANT SELECT,UPDATE,DELETE ON system_types TO qualification_admin;
GRANT SELECT,UPDATE,DELETE ON applications TO qualification_admin;
GRANT SELECT,UPDATE,DELETE ON application_versions TO qualification_admin;
GRANT SELECT,UPDATE,DELETE ON healthcare_providers TO qualification_admin;
GRANT SELECT,UPDATE,DELETE ON applications_roles TO qualification_admin;
GRANT SELECT,UPDATE,DELETE ON applications_types TO qualification_admin;
GRANT SELECT,UPDATE,DELETE ON healthcare_providers_application_versions TO qualification_admin;
GRANT SELECT,UPDATE,DELETE ON healthcare_providers_qualifications TO qualification_admin;
GRANT SELECT,UPDATE,DELETE ON protocol_application_qualifications TO qualification_admin;
;
